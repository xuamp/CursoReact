...
const Footer = (props) => {
    return (
		...
		<div className="pie2">
			<Link to="/https://www.instagram.com/dockmotion/" target="_blank"><i className="fa-brands fa-instagram"></i></Link>
			<Link to="/https://es-la.facebook.com/" target="_blank"><i className="fa-brands fa-facebook-f"></i></Link>
		</div>
	</footer>	
    )
}
